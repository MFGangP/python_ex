...
print("scores 의 주소값 : ", id(scores_copy))
...
print("scores 의 요소값 : ", scores_copy)
...
print("scores 의 주소값 : ", id(scores_index))
print("refer_copy 의 주소값 : ", id(refer_index))
refer_index[0] = 100
...
print("scores 의 요소값 : ", scores_index)
print("refer_copy 의 요소값 : ", refer_index)
print("-------------------------")