...
for i in range(len(double_list)):
    ...
    print() # 줄바꿈
# 2차원 리스트는 정적인 것 보다는 동적으로 생성하여 사용하는 경우가 많다.
...
#
# # 리스트 함축을 이용한 방법
# dbl_list = [([0] * cols) for rows in range(rows)]
# print(dbl_list)

# 1차원 리스트 에서는 list[0]값이 바로 변수와 동일하다.
