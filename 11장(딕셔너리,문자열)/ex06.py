...
# 인자값으로 구분자(seperator)를 주게되면 주어진 구분자로 문자열을 분리한다.
# 기본 인자값 공백이다.
string = "안녕 john 난 지금 학교 가고 있어"
li1 = string.split()    # 공백으로 분리
print(type(li1))
print(li1)
# 스플릿 메서드는 구분자를 하나밖에 받지 않는다.
string = "안녕,john,난,지금,학교,가고,있어"
li2 = string.split(",")    # 콤마으로 분리
print(li2)

# 정규 표현식을 사용하기 위해서 regex 모듈을 인스톨 하자
import regex
...
string = "12345"
print(string.isdigit())     # 문자열이 10진수 인지 확인하는 코드
print(string.isdecimal())     # 문자열이 10진수 인지 확인하는 코드
print("-----------------------------------------")
string = "abcd12345"
print(string.isalnum())     # 문자열이 영문자, 숫자인지 동시에 확인하는 코드
print("-----------------------------------------")
string = "½"
# numeric 굉장히 없은 의미인데, 숫자값 표현에 문자열을 인정해준다.
...
# endswith(문자열) 메소드는 인자값 문자열로 끝이 나면 True를 리턴한다.
...
# startswith(문자열) 메소드는 인자값 문자열로 시작하면 True를 리턴한다.
...
print(string.title())       # 앞 한글자만 대분자로 변경

print("-----------------------------------------")
# format()은 포맷 {}을 만들어놓고 문자열을 생성하는데 사용하는 것이다.
string = "{}b{}"
...
print("-----------------------------------------")
# partition() 전달받은 인자값으로 문자열을 나눈다. 리턴 타입은 튜플이다.
string = "eunhyuk@gmail.com"
print(string.partition("@"))

print("-----------------------------------------")
# count()은 인자값으로 들어오는 값을 문자열에서 몇 개 있는지 카운팅을 해준다.
...
# 직접 사용해야 한다)
string = "\t         aaaaaaaa         bbbbbbbbb          qccccc   ddddddd  \t"
print(string.strip())
print(string.rstrip())
print(string.lstrip())