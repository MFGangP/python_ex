...
dic3 = {}
print(dic3)
# set 객체도 역시 {}를 사용하기 때문에 혼돈이 있을 수가 있다. 하여 set을 생성 할
# 때는 내장함수인 set()을 사용해야 한다.
set1 = set()
print(set1)
...
print("dic4[1] 키의 값은 : ", dic4[1])
# 두 번째 방법은 get()을 사용하는 방법
print("dic[1]키의 값은 : ", dic4.get(1))
# 만약에 키가 딕셔너리에 존재하지 않으면 KeyError가 발생한다.
# print("dic[5]키의 값은 : ", dic4.get(5))    # 리턴값이 None
# print("dic[5]키의 값은 : ", dic4[5])        # 에러 발생
